...
const FIELDS = [
  ...
  { id: 'productoid', label: 'Producto', placeholder: 'Producto', required: true },
  ...
  { id: 'aclaraciones', label: 'Aclaraciones', placeholder: 'Aclaraciones', full: true }
];
      ...
      >
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <form className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'
                action='/api/tratamientos' method='post'>
            <Transition.Child
              as={Fragment}
              enter='ease-out duration-300'
